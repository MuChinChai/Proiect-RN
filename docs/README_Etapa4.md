...
| Detectarea automata a speciilor de peste | Analizare imagine si clasificare peste > 80% acuratete | RN + UI |
...
```
Generare toate datele (simulare, etichetare manuală - varianta recomandata)
...
|---------------------|-------------------------------------|--------------------------|
| **Date generate prin simulare fizică** | Peste care inoata | LabVIEW funcțional  |
| **Etichetare/adnotare manuală** | Etichetat manual 60 imagini  | Fisier cu poza + nume peste in fisier |
...
Datele au fost generate folosind Gemini AI, i-am specificat ce tip de peste sa imi genereze si marimea imaginii. 
